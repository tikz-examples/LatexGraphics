...
\begin{scope}[transform canvas={rotate=10,scale=0.7}]
...
% Cylindrical shape
\draw [top color=Dandelion,
			bottom color=Dandelion,
			middle color=Goldenrod,
			opacity=0.92] (0,-0.5) -- ++(12,0) 
	arc(-90:90:0.2 and 0.5) -- ++(-12,0) 
	arc(90:-90:0.2 and 0.5)--cycle;

\draw[fill=Goldenrod!10] (0,0) ellipse(0.2 and 0.5);
